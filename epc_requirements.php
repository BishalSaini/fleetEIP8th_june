...
<button class="generate-btn"> 
    <article class="article-wrapper" onclick="window.location.href='requirementlisting.php'" id="rentalclientbuttoncontainer"> 
  <div class="rounded-lg container-projectss ">
    </div>
    <div class="project-info">
      <div class="flex-pr">
        <div class="project-title text-nowrap">View Requirements</div>
...
<form action="epc_requirements.php" method="POST" class="epc_req1" autocomplete="off">
    <div class="epc_red_div" id="adminpanelepcreq">
        ...
        <div class="trial1 hideit">
            <input class="input02" name="comp_name" type="text" value=" <?php echo $companyname001 ?>" placeholder="" >
            ...
            <div class="outer02">
            <div class="trial1"> 
            <input class="input02" name="epc_email"  type="text" placeholder=""  >
        ...
        <div class="outer02">
            ...
            <div class="trial1 ">
                <select name="project_code" id="selectprojectcode" class="input02">
    ...
    <div class="outer02">
        ...
        <div class="outer02">
            ...
            <input type="hidden" name="posted_by" value="<?php echo $companyname001; ?>">
