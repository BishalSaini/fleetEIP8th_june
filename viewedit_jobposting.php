...
$sql="SELECT * FROM `job_posting` where sno='$edit_id' and company_name='$companyname001'";
...
<div class="navbar1">
    ...
    <form action="viewedit_jobposting.php" class="job_posting" method="POST" autocomplete="off">
