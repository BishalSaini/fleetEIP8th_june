...
<div class="generate-btn-container">
    <button class="generate-btn" onclick="window.location.href='vendorsView.php'">
...
<form action="vendorsFleet.php" method="POST" class="vendorform" autocomplete="off" style="margin-top: 40px;">
    <div class="rentalclientcontainer">
        <p class="headingpara">Add Vendor</p>
        <div class="trial1">
            <input type="text" placeholder="" name="vendor_name" class="input02" required>
            <label for="" class="placeholder2">Vendor Name</label>
        </div>
        <div class="trial1">
            <textarea placeholder="" name="office_address" class="input02" required></textarea>
    ...
    <option value="West Bengal">West Bengal</option>
        ...
        <div class="outer02">
        <div class="trial1">
            <input type="text" placeholder="" name="vendor_code" class="input02" required>
            <label for="" class="placeholder2">Vendor Code</label>
        </div>
        
            <select name="vendor_category" class="input02" required>
                <option value="" disabled selected>Vendor Category</option>
