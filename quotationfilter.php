...
$sql = "SELECT qg.*, qs.current_status 
        ...
        WHERE qg.company_name='$companyname001'";
...
<td data-label="Date"><?php echo date('d-m-y', strtotime($row['quote_date'])); ?></td>
    ...
    ?>
        ...
        <td data-label="Actions">
            <a href="edit_quotation.php?quote_id=<?php echo $row['sno']; ?>" class="quotation-icon" title="Edit">
                <i style="width: 22px; height: 22px;" class="bi bi-pencil"></i>
            </a>
            <a href="delete_quotation.php?del_id=<?php echo $row['sno']; ?>" class="quotation-icon" title="Delete">
