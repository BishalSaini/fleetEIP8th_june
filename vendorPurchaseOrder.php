...
$stmt->bind_param(
    ...
    if ($stmt->execute()) {
        ...
        $stmt->close();
         ...
         // Updated: Insert GST/CGST/SGST/price after columns as well
        $stmt2 = $conn->prepare("INSERT INTO purchase_order_products (
            ...
            gst, cgst, sgst, price_after_gst, price_after_cgst, price_after_sgst
        ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
        for ($i = 1; $i <= 5; $i++) {
            ...
            // Fetch GST/CGST/SGST/price after values for this row
            $gst = $_POST['gst_' . $i] ?? '';
            $cgst = $_POST['cgst_' . $i] ?? '';
            $sgst = $_POST['sgst_' . $i] ?? '';
            $price_after_gst = $_POST['price_after_gst_' . $i] ?? '';
            $price_after_cgst = $_POST['price_after_cgst_' . $i] ?? '';
            $price_after_sgst = $_POST['price_after_sgst_' . $i] ?? '';

            if (!empty($serial)) {
                $stmt2->bind_param(
                    "isssddddddddd",
                    $po_id, $serial, $name, $uom, $unit_price, $qty, $total,
                    $gst, $cgst, $sgst, $price_after_gst, $price_after_cgst, $price_after_sgst
                );
                $stmt2->execute();
            }
...
<html lang="en">
    ...
    <body>
        ...
        <form
                ...
                <div id="equipmentinfosectioncontainer">
                    ...
                    <div class="outer02">
                        <div class="trial1">
                            ...
                            <label for="gst_1" class="placeholder2">GST (%)</label>
                        </div>
                        <div class="trial1" >
                            <input
                                type="number"
                                ...
                                step="0.01"
                                min="0"
                                name="price_after_gst_1"
                                id="price_after_gst_1"
                                class="input02"
                                style="font-size:1.1rem;"
                                readonly="readonly">
                            <label for="price_after_gst_1" class="placeholder2">Price after GST</label>
                        </div>
                    </div>
                    <div class="outer02">
                        <div class="trial1" id="contact_number1">
                            <input
                                ...
                                style="font-size:1.1rem;"
                                readonly="readonly">
                            <label for="cgst_1" class="placeholder2">CGST (%)</label>
                        </div>
                            <div class="trial1" >
                                <input
                                    type="number"
                                    ...
                                    step="0.01"
                                    min="0"
                                    name="price_after_cgst_1"
                                    id="price_after_cgst_1"
                                    class="input02"
                                    style="font-size:1.1rem;"
                                    readonly="readonly">
                                <label for="price_after_cgst_1" class="placeholder2">Price after CGST</label>
                            </div>
                    </div>
                        <div class="outer02">
                            <div class="trial1 ">
                                <input
                                    ...
                                    readonly="readonly">
                                <label for="sgst_1" class="placeholder2">SGST (%)</label>
                            </div>
                            <div class="trial1" >
                                <input
                                    type="number"
                                    ...
                                    step="0.01"
                                    min="0"
                                    name="price_after_sgst_1"
                                    id="price_after_sgst_1"
                                    class="input02"
                                 
                                    readonly="readonly">
                                <label for="price_after_sgst_1" class="placeholder2">Price after SGST</label>
                            </div>
                        </div>
                        <input
                            type="text"
                        ...
                        <div class="trial1">
                            <input
                                ...
                                class="input02"
                                style="font-size:1.1rem;">
                            <label for="gst_2" class="placeholder2">GST (%)</label>
                        </div>
                        <div class="trial1" >
                            <input
                                type="number"
                                ...
                                step="0.01"
                                min="0"
                                name="price_after_gst_2"
                                id="price_after_gst_2"
                                class="input02"
                                style="font-size:1.1rem;"
                                readonly="readonly">
                            <label for="price_after_gst_2" class="placeholder2">Price after GST</label>
                        </div>
                    </div>
                    <div class="outer02">
                        <div class="trial1" id="contact_number1">
                            <input
                                ...
                                style="font-size:1.1rem;"
                                readonly="readonly">
                            <label for="cgst_2" class="placeholder2">CGST (%)</label>
                        </div>
                            <div class="trial1" >
                                <input
                                    type="number"
                                    ...
                                    step="0.01"
                                    min="0"
                                    name="price_after_cgst_2"
                                    id="price_after_cgst_2"
                                    class="input02"
                                    style="font-size:1.1rem;"
                                    readonly="readonly">
                                <label for="price_after_cgst_2" class="placeholder2">Price after CGST</label>
                            </div>
                    </div>
                        <div class="outer02">
                            <div class="trial1 ">
                                <input
                                    ...
                                    readonly="readonly">
                                <label for="sgst_2" class="placeholder2">SGST (%)</label>
                            </div>
                            <div class="trial1" >
                                <input
                                    type="number"
                                    ...
                                    step="0.01"
                                    min="0"
                                    name="price_after_sgst_2"
                                    id="price_after_sgst_2"
                                    class="input02"
                                 
                                    readonly="readonly">
                                <label for="price_after_sgst_2" class="placeholder2">Price after SGST</label>
                            </div>
                        </div>
                        <input
                            type="text"
                        ...
                        <div class="trial1">
                            <input
                                ...
                                class="input02"
                                style="font-size:1.1rem;">
                            <label for="gst_3" class="placeholder2">GST (%)</label>
                        </div>
                        <div class="trial1" >
                            <input
                                type="number"
                                ...
                                step="0.01"
                                min="0"
                                name="price_after_gst_3"
                                id="price_after_gst_3"
                                class="input02"
                                style="font-size:1.1rem;"
                                readonly="readonly">
                            <label for="price_after_gst_3" class="placeholder2">Price after GST</label>
                        </div>
                    </div>
                    <div class="outer02">
                        <div class="trial1" id="contact_number1">
                            <input
                                ...
                                style="font-size:1.1rem;"
                                readonly="readonly">
                            <label for="cgst_3" class="placeholder2">CGST (%)</label>
                        </div>
                            <div class="trial1" >
                                <input
                                    type="number"
                                    ...
                                    step="0.01"
                                    min="0"
                                    name="price_after_cgst_3"
                                    id="price_after_cgst_3"
                                    class="input02"
                                    style="font-size:1.1rem;"
                                    readonly="readonly">
                                <label for="price_after_cgst_3" class="placeholder2">Price after CGST</label>
                            </div>
                    </div>
                        <div class="outer02">
                            <div class="trial1 ">
                                <input
                                    ...
                                    readonly="readonly">
                                <label for="sgst_3" class="placeholder2">SGST (%)</label>
                            </div>
                            <div class="trial1" >
                                <input
                                    type="number"
                                    ...
                                    step="0.01"
                                    min="0"
                                    name="price_after_sgst_3"
                                    id="price_after_sgst_3"
                                    class="input02"
                                 
                                    readonly="readonly">
                                <label for="price_after_sgst_3" class="placeholder2">Price after SGST</label>
                            </div>
                        </div>

                        <!-- Hidden fields for product group 3 GST calculations -->
                        <input type="hidden" name="cgst_3" id="cgst_3" value="">
                        <input type="hidden" name="sgst_3" id="sgst_3" value="">
                        <input type="hidden" name="price_after_cgst_3" id="price_after_cgst_3" value="">
                        <input type="hidden" name="price_after_sgst_3" id="price_after_sgst_3" value="">
                        ...
                        <div class="trial1">
                            <input
                                ...
                                class="input02"
                                style="font-size:1.1rem;">
                            <label for="gst_4" class="placeholder2">GST (%)</label>
                        </div>
                        <div class="trial1" >
                            <input
                                type="number"
                                ...
                                step="0.01"
                                min="0"
                                name="price_after_gst_4"
                                id="price_after_gst_4"
                                class="input02"
                                style="font-size:1.1rem;"
                                readonly="readonly">
                            <label for="price_after_gst_4" class="placeholder2">Price after GST</label>
                        </div>
                    </div>
                    <div class="outer02">
                        <div class="trial1" id="contact_number1">
                            <input
                                ...
                                style="font-size:1.1rem;"
                                readonly="readonly">
                            <label for="cgst_4" class="placeholder2">CGST (%)</label>
                        </div>
                            <div class="trial1" >
                                <input
                                    type="number"
                                    ...
                                    step="0.01"
                                    min="0"
                                    name="price_after_cgst_4"
                                    id="price_after_cgst_4"
                                    class="input02"
                                    style="font-size:1.1rem;"
                                    readonly="readonly">
                                <label for="price_after_cgst_4" class="placeholder2">Price after CGST</label>
                            </div>
                    </div>
                        <div class="outer02">
                            <div class="trial1 ">
                                <input
                                    ...
                                    readonly="readonly">
                                <label for="sgst_4" class="placeholder2">SGST (%)</label>
                            </div>
                            <div class="trial1" >
                                <input
                                    type="number"
                                    ...
                                    step="0.01"
                                    min="0"
                                    name="price_after_sgst_4"
                                    id="price_after_sgst_4"
                                    class="input02"
                                 
                                    readonly="readonly">
                                <label for="price_after_sgst_4" class="placeholder2">Price after SGST</label>
                            </div>
                        </div>

                        <!-- Hidden fields for product group 4 GST calculations -->
                        <input type="hidden" name="cgst_4" id="cgst_4" value="">
                        <input type="hidden" name="sgst_4" id="sgst_4" value="">
                        <input type="hidden" name="price_after_cgst_4" id="price_after_cgst_4" value="">
                        <input type="hidden" name="price_after_sgst_4" id="price_after_sgst_4" value="">
                        ...
                        <div class="trial1">
                            <input
                                ...
                                class="input02"
                                style="font-size:1.1rem;">
                            <label for="gst_5" class="placeholder2">GST (%)</label>
                        </div>
                        <div class="trial1" >
                            <input
                                type="number"
                                ...
                                step="0.01"
                                min="0"
                                name="price_after_gst_5"
                                id="price_after_gst_5"
                                class="input02"
                                style="font-size:1.1rem;"
                                readonly="readonly">
                            <label for="price_after_gst_5" class="placeholder2">Price after GST</label>
                        </div>
                    </div>
                    <div class="outer02">
                        <div class="trial1" id="contact_number1">
                            <input
                                ...
                                style="font-size:1.1rem;"
                                readonly="readonly">
                            <label for="cgst_5" class="placeholder2">CGST (%)</label>
                        </div>
                            <div class="trial1" >
                                <input
                                    type="number"
                                    ...
                                    step="0.01"
                                    min="0"
                                    name="price_after_cgst_5"
                                    id="price_after_cgst_5"
                                    class="input02"
                                    style="font-size:1.1rem;"
                                    readonly="readonly">
                                <label for="price_after_cgst_5" class="placeholder2">Price after CGST</label>
                            </div>
                    </div>
                        <div class="outer02">
                            <div class="trial1 ">
                                <input
                                    ...
                                    readonly="readonly">
                                <label for="sgst_5" class="placeholder2">SGST (%)</label>
                            </div>
                            <div class="trial1" >
                                <input
                                    type="number"
                                    ...
                                    step="0.01"
                                    min="0"
                                    name="price_after_sgst_5"
                                    id="price_after_sgst_5"
                                    class="input02"
                                 
                                    readonly="readonly">
                                <label for="price_after_sgst_5" class="placeholder2">Price after SGST</label>
                            </div>
                        </div>

                        <!-- Hidden fields for product group 5 GST calculations -->
                        <input type="hidden" name="cgst_5" id="cgst_5" value="">
                        <input type="hidden" name="sgst_5" id="sgst_5" value="">
                        <input type="hidden" name="price_after_cgst_5" id="price_after_cgst_5" value="">
                        <input type="hidden" name="price_after_sgst_5" id="price_after_sgst_5" value="">
            ...
            <script>
                $(document).ready(function () {
                    ...
                    $('#vendor_name').on('keyup focus', function () {
                        // Prevent dropdown if adding a new vendor
                        if ($('#is_new_vendor').val() === '1') {
                            $('#vendorDropdown').hide();
                            return;
                        }
                        let query = $(this)
            ...
            <script>
                $(document).ready(function () {
                    ...
                    function fillProductFields(group, product) {
                        ...
                        // Autofill GST, CGST, SGST, and price-after fields if present in product
                        if (typeof product.gst !== 'undefined') {
                            // Set GST
                            $('#gst_' + group).val(product.gst);
                            // Set CGST/SGST (if not present, split GST)
                            var cgst = (typeof product.cgst !== 'undefined' && product.cgst !== null) ? product.cgst : (product.gst / 2);
                            var sgst = (typeof product.sgst !== 'undefined' && product.sgst !== null) ? product.sgst : (product.gst / 2);
                            $('#cgst_' + group).val(cgst);
                            $('#sgst_' + group).val(sgst);

                            // Calculate price after GST/CGST/SGST if not provided
                            var price = parseFloat(product.unit_price) || 0;
                            var gstVal = parseFloat(product.gst) || 0;
                            ...
                            $('#price_after_gst_' + group).val(
                                (typeof product.price_after_gst !== 'undefined' && product.price_after_gst !== null)
                                    ? product.price_after_gst
                                    : (price + gstAmount).toFixed(2)
                            );
                            $('#price_after_cgst_' + group).val(
                                (typeof product.price_after_cgst !== 'undefined' && product.price_after_cgst !== null)
                                    ? product.price_after_cgst
                                    : (price + cgstAmount).toFixed(2)
                            );
                            $('#price_after_sgst_' + group).val(
                                (typeof product.price_after_sgst !== 'undefined' && product.price_after_sgst !== null)
                                    ? product.price_after_sgst
                                    : (price + sgstAmount).toFixed(2)
                            );
                        }
                        $('#productSerialDropdown_' + group + ', #productNameDropdown_' + group).hide();
                    }
            ...
            <script>
                $(document).ready(function () {
                    ...
                    function showTeamMemberDropdown($dropdown, data, query) {
                        ...
                        if (!found && query) {
                            $dropdown.append(
                                $('<li>').addClass('add-new-member').css({'color': 'blue', 'cursor': 'pointer', 'padding': '8px 16px'}).text(
                    ...
                    document.addEventListener('DOMContentLoaded', function () {
                        ...
                        function updateGSTFields() {
                            ...
                            cgstInput.value = cgstVal.toFixed(2);
                            sgstInput.value = sgstVal.toFixed(2);
            ...
            <script>
                // GST split and price calculation for all product rows
                document.addEventListener('DOMContentLoaded', function () {
                    function updateGSTFieldsForRow(row) {
                        var gstInput = document.getElementById('gst_' + row);
                        var cgstInput = document.getElementById('cgst_' + row);
                        var sgstInput = document.getElementById('sgst_' + row);
                        var unitPriceInput = document.getElementById('unit_price_' + row);
                        var priceAfterGst = document.getElementById('price_after_gst_' + row);
                        var priceAfterCgst = document.getElementById('price_after_cgst_' + row);
                        var priceAfterSgst = document.getElementById('price_after_sgst_' + row);

                        if (!gstInput || !cgstInput || !sgstInput || !unitPriceInput || !priceAfterGst || !priceAfterCgst || !priceAfterSgst) return;
                        ...
                        gstInput.addEventListener('input', update);
                        unitPriceInput.addEventListener('input', update);
                    }

                    // Add IDs to all GST/CGST/SGST/unit price/price after fields for each row (1-5)
                    for (var i = 1; i <= 5; i++) {
                        // Add IDs if not present (for backward compatibility)
                        var gst = document.getElementsByName('gst')[i-1];
                        var cgst = document.getElementsByName('cgst')[i-1];
                        var sgst = document.getElementsByName('sgst')[i-1];
                        var unitPrice = document.getElementById('unit_price_' + i);
                        var priceAfterGst = document.getElementsByName('price_after_gst')[i-1];
                        var priceAfterCgst = document.getElementsByName('price_after_cgst')[i-1];
                        var priceAfterSgst = document.getElementsByName('price_after_sgst')[i-1];

                        if (gst) gst.id = 'gst_' + i;
                        if (cgst) cgst.id = 'cgst_' + i;
                        if (sgst) sgst.id = 'sgst_' + i;
                        if (priceAfterGst) priceAfterGst.id = 'price_after_gst_' + i;
                        if (priceAfterCgst) priceAfterCgst.id = 'price_after_cgst_' + i;
                        if (priceAfterSgst) priceAfterSgst.id = 'price_after_sgst_' + i;
                        // unitPrice already has id="unit_price_i"

                        updateGSTFieldsForRow(i);
                    }
                });
            </script>
