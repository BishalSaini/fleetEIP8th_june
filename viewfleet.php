  ...
  <option value="CHS">CHS</option>
    ...
    <label class="placeholder2">YOM</label>
        ...
        <div class="trial1" id="forklift_height">
            <input type="number" step="0.1" name="height_meter" placeholder="" class="input02">
            <label for="" class="placeholder2">Height/Meter</label>
        </div>
        <div class="outer02" id="tower_crane">
            <div class="trial1">
                <input type="number" step="0.1" name="total_height" id="total_height_input"  placeholder="" class="input02">
                <label for="" class="placeholder2 tip_load_in_tons">Total Height In Mtr</label>
            </div>
            <div class="trial1">
                <input type="number" step="0.1" name="free_standing_height" id="free_standing_height"  placeholder="" class="input02">
                <label for="" id="" class="placeholder2 tip_load_in_tons">Free Standing Height</label>
            </div>
            <div class="trial1">
                <input type="number" step="0.1" name="tipload" id="tip_load_height" placeholder="" class="input02">
        ...
        <div class="trial1" id="boom_input" >
            <input type="number" name="boomLength" step="0.1"  placeholder="" class=" input02" >
            <label class="placeholder2">Boom Length</label>
        </div>    
        <div class="trial1" id="jib_input">
            <input type="number" name="jibLength" step="0.1" placeholder="" class="input02 " >
            <label class="placeholder2">Jib Length</label>
        </div>
        <div class="trial1" id="luffing_input">
            <input type="number" name="luffingLength" step="0.1" placeholder="" class=" input02" >
            <label class="placeholder2">Luffing Length</label>
        </div>
        </div>
        <div class="trial1" id="kealy_length">
            <input type="text" name='kealy' placeholder="" step="0.1" class="input02">
            <label for="" class="placeholder2">Kealy Length</label>
        </div>
        <div class="trial1" id="pipelength">
            <input type="text" name='pipeline' step="0.1" placeholder="" class="input02">
