...
if(isset($_POST['JOB_submit'])){
    ...
    $sql="INSERT INTO `job_posting` (`minimum_experience`,`job_heading`, `job_location`, `pay_range`, `contact_person`,
     `designation`, `email`, `contact_number`, `valid_till`, `roles`,
      `education`, `perks`, `company_name`) VALUES ('$minimum_experience','$job_heading', '$job_location', '$pay_range', '$contact_person', '$designation',
       '$email', '$contact_number', '$valid_till', '$roles', '$education', '$perks','$companyname')";
...
<form action="job_posting.php" class="job_posting" method="POST" autocomplete="off">
