...
$job_id=$_GET['id'];
$sql="SELECT * FROM `job_application_apply` where job_id='$job_id' and applying_for_company='$companyname001' and status='verified'";
$result=mysqli_query($conn,$sql);

$sql_="SELECT * FROM `job_posting` where sno='$job_id' and company_name='$companyname001'";
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        <td>
            <div class="custom-card" id="application_card">
                <h3 class="custom-card__title"><?php echo $row['name'] ?></h3>
