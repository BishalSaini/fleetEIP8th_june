...
?>
    ...
    <div class="generate_logi_requirement">
        ...
        <article class="article-wrapper" id="post_rfq_button" onclick="location.href='adminpostedjob.php'">
    ...
    $result = mysqli_query($conn, "SELECT * FROM `job_posting` where `added_by`='$companyname001' ORDER BY sno desc");
    ...
    if(mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo '<td>
            <a href="adminviewapplication.php?id=' . urlencode($id) . '" class="custom-card-link">
...
<a href="admineditjob.php?id=' . urlencode($id) . '" class="custom-card-link">
