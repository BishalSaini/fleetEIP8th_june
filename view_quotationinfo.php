...
.companylogo img{
    ...
    max-width: 120px; /* Prevent image from overflowing its container */
    max-height: 120px; /* Prevent image from overflowing its container */
...
<div class="button_container">
    ...
    <button class="print_quotation"  type="button" onclick="window.location.href='quotationinfo.php?id=<?php echo $sendername; ?>'">Go Back</button>
...
?>/- one time </p>
                ...
                <p>Cap <?php echo $row3equipment['cap2'] . " " . $row3equipment['cap_unit2']; ?> | Fuel: <?php echo $row3equipment['fuel/hour2'] ?>ltrs/hour | Adblue:<?php echo $row3equipment['adblue2'] ?> </p>
...
?>/- one time </p>
                ...
                <p>Cap <?php echo $row4equipment['cap2'] . " " . $row4equipment['cap_unit2']; ?> | Fuel: <?php echo $row4equipment['fuel/hour2'] ?>ltrs/hour | Adblue:<?php echo $row4equipment['adblue2'] ?> </p>
...
?>/- one time </p>
                ...
                <p>Cap <?php echo $row5equipment['cap2'] . " " . $row5equipment['cap_unit2']; ?> | Fuel: <?php echo $row5equipment['fuel/hour2'] ?>ltrs/hour | Adblue:<?php echo $row5equipment['adblue2'] ?> </p>
