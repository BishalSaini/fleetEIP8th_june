...
if (mysqli_affected_rows($conn) == 0 && !empty($asset_code1)) {
    $insert_query2 = "
        INSERT INTO `second_vehicle_quotation` (
            `category2`,`fuelUnit`, `asset_code2`, `yom2`, `make2`, `model2`, `sub_type2`, 
            ...
            '$fleet_category1','$fuelUnit2', '$asset_code1', '$yom2', '$newfleetmake1', 
...
if (mysqli_affected_rows($conn) == 0 && !empty($asset_code3)) {
        ...
        INSERT INTO `thirdvehicle_quotation` (
            ...
            '$fleet_category3','$fuelUnit3', '$asset_code3', '$newyom3', '$newfleetmake3', 
...
if (mysqli_affected_rows($conn) == 0 && !empty($asset_code4)) {
        ...
        INSERT INTO `fourthvehicle_quotation` (
            ...
            '$fleet_category4','$fuelUnit4', '$asset_code4', '$newyom4', '$newfleetmake4', 
...
if (mysqli_affected_rows($conn) == 0 && !empty($asset_code5)) {
        ...
        INSERT INTO `fifthvehicle_quotation` (
            ...
            '$fleet_category5','$fuelUnit5', '$asset_code5', '$newyom5', '$newfleetmake5', 
...
<form action="editquotation.php" method="POST" class="generate_quotation" autocomplete="off" enctype="multipart/form-data">
...
>
  ...
  <p class="translate-x-1" >Next</p>
    ...
    <option <?= ($row['asset_code'] === 'New Equipment') ? 'selected' : '' ?> value="New Equipment">Choose New Equipment</option>

    <?php while ($row_asset_code = mysqli_fetch_assoc($result_asset_code1)) { 
        $status = $row_asset_code['status'];
        $color = ($status === "Idle") ? "orange" : (($status === "Working") ? "red" : "white"); ?>
        
        <option value="<?= $row_asset_code['assetcode'] ?>" 
            style="background-color: <?= $color ?>;"
            <?= ($row_asset_code['assetcode'] === $row['asset_code']) ? 'selected' : '' ?>>
            <?= $row_asset_code['assetcode'] ?> (<?= $row_asset_code['sub_type'] ?> <?= $row_asset_code['make'] ?> <?= $row_asset_code['model'] ?>) - <?= $status ?>
        </option>
    <?php } ?>
</select>        </div>
...
<option <?php if($row['sub_Type'] === 'Diesel Generator'){echo 'selected';} ?> value="Diesel Generator" class="generator_options" id="generator_option">Diesel Generator</option>
    ...
    <div class="outer02" id="">
    <div class="trial1">
            <input type="text" id="yom" placeholder="" value="<?php echo $row['yom'] ?>" name="yom_fleet" class="input02" >
            <label for="" class="placeholder2">YOM</label>
        </div>
    ...
    <div class="availableouter" id="">
    <!-- newfleet_jib -->
    <div class="trial1 width350 <?php if(empty($row['boom'])){echo 'hideit';} ?>" >
        ...
        <div class="trial1 width350 <?php if(empty($row['jib'])){echo 'hideit';} ?>" >
        ...
        <div class="trial1 width350 <?php if(empty($row['luffing'])){echo 'hideit';} ?>">
    ...
    <div class="trial1">
        ...
        <div class="trial1">
            ...
            <select name="fuelUnit" id="unit1" class="input02 ">
                <option value=""disabled selected>Unit</option>
                <option <?php if($row['fuelUnit']==='ltrs/hour'){echo 'selected';} ?> value="ltrs/hour">ltrs/hour</option>
                <option <?php if($row['fuelUnit']==='kms/ltrs'){echo 'selected';} ?> value="kms/ltrs">kms/ltrs</option>
            </select>
...
<option <?php if (isset($row2['sub_type2']) && $row2['sub_type2'] === 'Diesel Generator') echo 'selected'; ?> value="Diesel Generator" class="generator_options" id="generator_option3">Diesel Generator</option>
    ...
    <div class="availableouter mt-10px" >
        <div class="trial1 width350">
...
<option <?php if (isset($row2['availability2']) && $row2['availability2'] === 'Not Immediate') { echo 'selected'; } ?> value="Not Immediate">Select A Date</option>
    ...
    <div class="outer02" id="">
    <div class="trial1">
            <input type="text" placeholder=""  id="yom_second"      value="<?php echo isset($row2['yom2']) ? $row2['yom2'] : ''; ?>" 
    ...
    <div class="outer02" id="">
    <div class="trial1 <?php if(isset($row2['boom']) && empty($row2['boom'])){echo 'hideit';} ?>" >
        ...
        <div class="trial1 <?php if(isset($row2['jib2']) && empty($row2['jib2'])){echo 'hideit';} ?>" >
            <input type="text" name="jibLength2"  id="jiblength_second"      value="<?php echo isset($row2['jib2']) ? $row2['jib2'] : ''; ?>" 
            placeholder="" class="input02 " >
            <label class="placeholder2">Jib Length</label>
        </div>
        <div class="trial1 <?php if(isset($row2['luffing2']) && empty($row2['luffing2'])){echo 'hideit';} ?>">
        ...
        <select name="fuelUnit2" id="unit1" class="input02 ">
                <option value=""disabled selected>Unit</option>
                <option <?php if(isset($row2['fuelUnit']) && $row2['fuelUnit']==='ltrs/hour'){echo 'selected';} ?> value="ltrs/hour">ltrs/hour</option>
                <option <?php if(isset($row2['fuelUnit']) && $row2['fuelUnit']==='kms/ltrs'){echo 'selected';} ?> value="kms/ltrs">kms/ltrs</option>
            </select>
...
<option <?php if (isset($row3['sub_type2']) && $row3['sub_type2'] === 'Diesel Generator') { echo 'selected'; } ?> value="Diesel Generator" class="generator_options3" id="generator_option3">Diesel Generator</option>
    ...
    <div class="trial1 <?php if(isset($row3['boom2']) && empty($row3['boom2'])){echo 'hideit';} ?>" >
        ...
        <select name="fuelUnit3" id="unit1" class="input02 ">
                <option value=""disabled selected>Unit</option>
                <option <?php if(isset($row3['fuelUnit']) && $row3['fuelUnit']==='ltrs/hour'){echo 'selected';} ?> value="ltrs/hour">ltrs/hour</option>
                <option <?php if(isset($row3['fuelUnit']) && $row3['fuelUnit']==='kms/ltrs'){echo 'selected';} ?> value="kms/ltrs">kms/ltrs</option>
            </select>
...
<option <?php if (isset($row4['sub_type2']) && $row4['sub_type2'] === 'Diesel Generator') { echo 'selected'; } ?> id="generator_option3" class="generator_options4" value="Diesel Generator">Diesel Generator</option>
    ...
    <div class="trial1 <?php if(isset($row4['boom2']) && empty($row4['boom2'])){echo 'hideit';} ?>" >
        ...
        <select name="fuelUnit4" id="unit1" class="input02 ">
                <option value=""disabled selected>Unit</option>
                <option <?php if(isset($row4['fuelUnit']) && $row4['fuelUnit']==='ltrs/hour'){echo 'selected';} ?> value="ltrs/hour">ltrs/hour</option>
                <option <?php if(isset($row4['fuelUnit']) && $row4['fuelUnit']==='kms/ltrs'){echo 'selected';} ?> value="kms/ltrs">kms/ltrs</option>
            </select>
...
<option <?php if(isset($row5['sub_type2']) && $row5['sub_type2'] === 'Diesel Generator'){ echo 'selected'; } ?> value="Diesel Generator" class="generator_options5" id="generator_option3">Diesel Generator</option>
    ...
    <div class="trial1 <?php if(isset($row5['boom2']) && empty($row5['boom2'])){echo 'hideit';} ?>" >
        ...
        <select name="fuelUnit5" id="unit1" class="input02 ">
                <option value=""disabled selected>Unit</option>
                <option <?php if(isset($row5['fuelUnit']) && $row5['fuelUnit']==='ltrs/hour'){echo 'selected';} ?> value="ltrs/hour">ltrs/hour</option>
                <option <?php if(isset($row5['fuelUnit']) && $row5['fuelUnit']==='kms/ltrs'){echo 'selected';} ?> value="kms/ltrs">kms/ltrs</option>
            </select>
...
// document.addEventListener('DOMContentLoaded', function() {
//     // Check if oem_fleet_type7 is not empty and call seco_equip_2()
//     var editFleetCategory1 = document.getElementById('editFleetCategory1');
//     if (editFleetCategory1.value !== '') {
//         updateAssetCode(editFleetCategory1);
